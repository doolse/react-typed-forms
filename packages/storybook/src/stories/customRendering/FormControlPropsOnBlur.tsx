...
// language=text
const formControlPropsOnBlurExampleCode = `    
// Example code
export function FormControlPropsOnBlurExample() {
...
export const FormControlPropsOnBlur: PlainStory = {
  parameters: {
    docs: {
      description: {
      ...
      source: {
        language: "tsx",
        code: formControlPropsOnBlurExampleCode,
      },
    },
  },
  render: () => {
